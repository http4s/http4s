  ...
  def multipartSpec(name: String)(
    ...
    s"Multipart form data $name" should {
      ...
      "encoded and decoded with binary data" in {
        ...
        val field1 = Part.formData[IO]("field1", "Text_Field_1")
        val field2 = Part.fileData[IO]("image", file, Http4sSpec.TestBlockingExecutionContext, `Content-Type`(MediaType.image.png))
...
--bQskVplbbxbC2JO8ibZ7KwmEe3AJLx_Olz--
  ...
  multipartSpec("with mixed decoder")(MultipartDecoder.mixedMultipart[IO](Http4sSpec.TestBlockingExecutionContext))
