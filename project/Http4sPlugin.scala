...
object Http4sPlugin extends AutoPlugin {
  ...
  lazy val catsKernelLaws                   = Def.setting("org.typelevel"          %% "cats-kernel-laws"          % catsLaws.value.revision)
  lazy val catsLaws                         = Def.setting("org.typelevel"          %% "cats-laws"                 % "1.0.0-RC1")
  ...
  lazy val fs2Io                            = "co.fs2"                 %% "fs2-io"                    % "0.10.0-M9"
  lazy val fs2ReactiveStreams               = "com.github.zainab-ali"  %% "fs2-reactive-streams"      % "0.2.6"
  lazy val fs2Scodec                        = Def.setting("co.fs2"                 %%% "fs2-scodec"                % fs2Io.revision)
  ...
  lazy val specs2Core                       = Def.setting("org.specs2"             %%% "specs2-core"               % "4.0.2")
