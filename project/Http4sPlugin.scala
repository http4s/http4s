...
object Http4sPlugin extends AutoPlugin {
  ...
  lazy val jawnFs2                          = "org.http4s"             %% "jawn-fs2"                  % "0.15.0-M2"
  ...
  lazy val jettyServer                      = "org.eclipse.jetty"      %  "jetty-server"              % "9.4.20.v20190813"
  ...
  lazy val log4catsCore                     = "io.chrisdavenport"      %% "log4cats-core"             % "1.0.0-RC3"
  ...
  lazy val okhttp                           = "com.squareup.okhttp3"   %  "okhttp"                    % "4.1.1"
