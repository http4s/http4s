...
object Http4sPlugin extends AutoPlugin {
  ...
  lazy val fs2Io                            = "co.fs2"                 %% "fs2-io"                    % "0.15.0" // Changed Due to Custom FS2
  lazy val fs2ReactiveStreams               = "com.github.zainab-ali"  %% "fs2-reactive-streams"      % "0.15.0" // Changed Due to Custom FS2
  ...
  lazy val jawnFs2                          = "org.http4s"             %% "jawn-fs2"                  % "0.15.0" // Changed Due to Custom FS2
