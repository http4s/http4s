...
object Http4sPlugin extends AutoPlugin {
  ...
  lazy val fs2Io                            = "co.fs2"                 %% "fs2-io"                    % "0.10.0-M2"
  lazy val fs2ReactiveStreams               = "com.github.zainab-ali"  %% "fs2-reactive-streams"      % "0.2.0-SNAPSHOT"
  ...
  lazy val jawnFs2                          = "org.http4s"             %% "jawn-fs2"                  % "0.11.0-SNAPSHOT"
