  ...
  def build: Resource[F, Client[F]] = for {
    ...
    pool <- KeyPool.create[F, RequestKey, (RequestKeySocket[F], F[Unit])](
        {requestKey: RequestKey => 
          org.http4s.ember.client.internal.ClientHelpers.requestKeyToSocketWithKey[F](
            requestKey,
            sslContextOpt,
            sg
    ...
    val client = Client[F](request =>
      for {
        ...
        response <- Resource.make(org.http4s.ember.client.internal.ClientHelpers.request[F](
            request,
            managed.resource._1,
            chunkSize,
