...
// service: org.http4s.HttpService = Kleisli(org.http4s.package$HttpService$$$Lambda$6414/296533375@3ca0d349)
```
...
task: scalaz.concurrent.Task[org.http4s.Response] = scalaz.concurrent.Task@2f676549
```
...
```scala
scala> val okTask = Ok()
okTask: scalaz.concurrent.Task[org.http4s.Response] = scalaz.concurrent.Task@4a25d864
...
scala> val task = Ok(Future {
     ...
     | })
task: scalaz.concurrent.Task[org.http4s.Response] = scalaz.concurrent.Task@7ad8ef23
...
scala> val task = Ok(Task {
     ...
     | })
task: scalaz.concurrent.Task[org.http4s.Response] = scalaz.concurrent.Task@29c4693a
