...
// helloWorldService: org.http4s.HttpService = Kleisli(org.http4s.package$HttpService$$$Lambda$6783/796162916@485abbb3)
```
...
// usersService: org.http4s.HttpService = Kleisli(org.http4s.package$HttpService$$$Lambda$6783/796162916@71bf1fd5)
```
...
// dailyWeatherService: org.http4s.HttpService = Kleisli(org.http4s.package$HttpService$$$Lambda$6783/796162916@3097ec16)
```
...
// yearQueryParamDecoder: org.http4s.QueryParamDecoder[java.time.Year] = $anon$1@37c2fe3a
...
// averageTemperatureService: org.http4s.HttpService = Kleisli(org.http4s.package$HttpService$$$Lambda$6783/796162916@336a8ea8)
``` 
...
// tweetService: org.http4s.HttpService = Kleisli(org.http4s.package$HttpService$$$Lambda$6783/796162916@4074e9c2)
```
...
// builder: org.http4s.server.blaze.BlazeBuilder = org.http4s.server.blaze.BlazeBuilder@273c2d6d
```
...
// client: org.http4s.client.Client = Client(Kleisli(org.http4s.client.blaze.BlazeClient$$$Lambda$6837/826611828@7c8f3922),scalaz.concurrent.Task@70b08b0a)
```
...
// helloJames: scalaz.concurrent.Task[String] = scalaz.concurrent.Task@43cae912
```
...
// greetingList: scalaz.concurrent.Task[List[String]] = scalaz.concurrent.Task@fcec50b
```
