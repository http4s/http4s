...
// helloWorldService: org.http4s.HttpService = Kleisli(org.http4s.package$HttpService$$$Lambda$6831/1447862418@58efcc32)
```
...
// usersService: org.http4s.HttpService = Kleisli(org.http4s.package$HttpService$$$Lambda$6831/1447862418@cae32d7)
```
...
// dailyWeatherService: org.http4s.HttpService = Kleisli(org.http4s.package$HttpService$$$Lambda$6831/1447862418@2a17bc40)
```
...
// yearQueryParamDecoder: org.http4s.QueryParamDecoder[java.time.Year] = $anon$1@6fe9cfae
...
// averageTemperatureService: org.http4s.HttpService = Kleisli(org.http4s.package$HttpService$$$Lambda$6831/1447862418@4a7032c4)
``` 
...
// tweetService: org.http4s.HttpService = Kleisli(org.http4s.package$HttpService$$$Lambda$6831/1447862418@482212dc)
```
...
// builder: org.http4s.server.blaze.BlazeBuilder = org.http4s.server.blaze.BlazeBuilder@ae765f2
```
...
// client: org.http4s.client.Client = Client(Kleisli(org.http4s.client.blaze.BlazeClient$$$Lambda$6886/908320519@1ae5a68d),scalaz.concurrent.Task@4cf999e)
```
...
// helloJames: scalaz.concurrent.Task[String] = scalaz.concurrent.Task@4ef83106
```
...
// greetingList: scalaz.concurrent.Task[List[String]] = scalaz.concurrent.Task@3d375bdf
```
