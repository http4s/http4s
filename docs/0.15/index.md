...
// helloWorldService: org.http4s.HttpService = Kleisli(org.http4s.package$HttpService$$$Lambda$6581/739591853@3262aede)
```
...
// usersService: org.http4s.HttpService = Kleisli(org.http4s.package$HttpService$$$Lambda$6581/739591853@7cce9ff0)
```
...
// dailyWeatherService: org.http4s.HttpService = Kleisli(org.http4s.package$HttpService$$$Lambda$6581/739591853@3e85d209)
```
...
// yearQueryParamDecoder: org.http4s.QueryParamDecoder[java.time.Year] = $anon$1@5d7f8051
...
// averageTemperatureService: org.http4s.HttpService = Kleisli(org.http4s.package$HttpService$$$Lambda$6581/739591853@53232610)
``` 
...
// tweetService: org.http4s.HttpService = Kleisli(org.http4s.package$HttpService$$$Lambda$6581/739591853@10878316)
```
...
// builder: org.http4s.server.blaze.BlazeBuilder = org.http4s.server.blaze.BlazeBuilder@65059c00
```
...
// client: org.http4s.client.Client = Client(Kleisli(org.http4s.client.blaze.BlazeClient$$$Lambda$6641/1302837520@43162823),scalaz.concurrent.Task@5d69a573)
```
...
// helloJames: scalaz.concurrent.Task[String] = scalaz.concurrent.Task@1c949cfc
```
...
// greetingList: scalaz.concurrent.Task[List[String]] = scalaz.concurrent.Task@79c3195f
```
