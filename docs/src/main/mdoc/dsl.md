...
object YearQueryParamMatcher2 extends QueryParamDecoderMatcher[Year]("year")
...
val averageTemperatureService = HttpRoutes.of[IO] {
  case GET -> Root / "weather" / "temperature" :? CountryQueryParamMatcher(country) +& YearQueryParamMatcher2(year)  =>
...
```scala mdoc
object YearQueryParamMatcher3 extends ValidatingQueryParamDecoderMatcher[Year]("year")

val routes = HttpRoutes.of[IO] {
  case GET -> Root / "temperature" :? YearQueryParamMatcher3(yearValidated) =>
    yearValidated.fold(
