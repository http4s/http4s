...
// builder: org.http4s.server.blaze.BlazeBuilder = org.http4s.server.blaze.BlazeBuilder@140a4fbe
...
// httpClient: org.http4s.client.Client = Client(Kleisli(<function1>),scalaz.concurrent.Task@15b2a356)
```
...
// helloJames: scalaz.concurrent.Task[String] = scalaz.concurrent.Task@209594ff
```
...
// greetingList: scalaz.concurrent.Task[List[String]] = scalaz.concurrent.Task@6d619814
```
