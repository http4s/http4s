...
// service: org.http4s.HttpService = Kleisli(org.http4s.package$HttpService$$$Lambda$6368/1190703637@5f4217d4)
```
...
// builder: org.http4s.server.blaze.BlazeBuilder = org.http4s.server.blaze.BlazeBuilder@2a4f708d
```
...
// client: org.http4s.client.Client = Client(Kleisli(org.http4s.client.blaze.BlazeClient$$$Lambda$6382/1922439057@7fcfc9bc),scalaz.concurrent.Task@7c648f13)
```
...
//        val helloJames = client.getAs[String]("http://localhost:8080/hello/James")
//                                ^
// helloJames: scalaz.concurrent.Task[String] = scalaz.concurrent.Task@405c7867
```
...
// greetingList: scalaz.concurrent.Task[List[String]] = scalaz.concurrent.Task@68ffb657
```
