...
// helloWorldService: org.http4s.HttpService = Kleisli(org.http4s.package$HttpService$$$Lambda$6518/737803982@3a77877d)
```
...
// usersService: org.http4s.HttpService = Kleisli(org.http4s.package$HttpService$$$Lambda$6518/737803982@32b57330)
```
...
// dailyWeatherService: org.http4s.HttpService = Kleisli(org.http4s.package$HttpService$$$Lambda$6518/737803982@23a2a62a)
```
...
// yearQueryParamDecoder: org.http4s.QueryParamDecoder[java.time.Year] = $anon$1@725a45fe
...
// averageTemperatureService: org.http4s.HttpService = Kleisli(org.http4s.package$HttpService$$$Lambda$6518/737803982@1bd047f)
``` 
...
// tweetService: org.http4s.HttpService = Kleisli(org.http4s.package$HttpService$$$Lambda$6518/737803982@416c28d7)
```
...
// builder: org.http4s.server.blaze.BlazeBuilder = org.http4s.server.blaze.BlazeBuilder@4c8bd1d3
```
...
// client: org.http4s.client.Client = Client(Kleisli(org.http4s.client.blaze.BlazeClient$$$Lambda$6579/522067006@4922cda3),scalaz.concurrent.Task@76a4a173)
```
...
// helloJames: scalaz.concurrent.Task[String] = scalaz.concurrent.Task@2415c2dd
```
...
// greetingList: scalaz.concurrent.Task[List[String]] = scalaz.concurrent.Task@4cef8b80
```
