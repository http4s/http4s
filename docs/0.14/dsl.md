...
// service: org.http4s.HttpService = Kleisli(org.http4s.package$HttpService$$$Lambda$6580/195607710@1036d67e)
```
...
task: scalaz.concurrent.Task[org.http4s.Response] = scalaz.concurrent.Task@5dfb9dfa
```
...
```scala
scala> val okTask = Ok()
okTask: scalaz.concurrent.Task[org.http4s.Response] = scalaz.concurrent.Task@45d682c3
...
scala> val task = Ok(Future {
     ...
     | })
task: scalaz.concurrent.Task[org.http4s.Response] = scalaz.concurrent.Task@1250c49
...
scala> val task = Ok(Task {
     ...
     | })
task: scalaz.concurrent.Task[org.http4s.Response] = scalaz.concurrent.Task@5cd75e3
