...
// service: org.http4s.HttpService = Kleisli(org.http4s.package$HttpService$$$Lambda$6641/1029719268@24453e17)
```
...
task: scalaz.concurrent.Task[org.http4s.Response] = scalaz.concurrent.Task@7ac5416
```
...
```scala
scala> val okTask = Ok()
okTask: scalaz.concurrent.Task[org.http4s.Response] = scalaz.concurrent.Task@41bc15a9
...
scala> val task = Ok(Future {
     ...
     | })
task: scalaz.concurrent.Task[org.http4s.Response] = scalaz.concurrent.Task@70b1383a
...
scala> val task = Ok(Task {
     ...
     | })
task: scalaz.concurrent.Task[org.http4s.Response] = scalaz.concurrent.Task@6ddb8355
