...
/** Common rules defined in RFC2616. This RFC is now obsolete, but some other active ones still
  * refer to it.
  *
  * @see
  *   [[https://tools.ietf.org/html/rfc2616#section-2.2] RFC2616, Basic Rules]
  */
