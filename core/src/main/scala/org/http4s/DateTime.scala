/**
 * Derived from https://raw.githubusercontent.com/spray/akka/53d43846c15969f9e5d36e94570f1fdb6e5bca7d/akka-http-core/src/main/scala/akka/http/util/DateTime.scala
 * Copyright (C) 2009-2013 Typesafe Inc. <http://www.typesafe.com>
 */
package org.http4s

import org.http4s.util.{Writer, StringWriter, Renderable}
...
final class DateTime private (val year: Int, // the year
                             ...
                             extends Ordered[DateTime] with Renderable with Product6[Int, Int, Int, Int, Int, Int] {
  /**
