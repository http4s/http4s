...
/*
    ...
    def apply(protocols: String, headers: HttpHeaders = HttpHeaders.Empty): Response =
      Response(ResponsePrelude(this, HttpHeaders.RawHeader("Upgrade", protocols) +: headers), Response.EmptyBody)
*/
  }
...
/*
    // TODO type this header
    def apply(wwwAuthenticate: String, body: ResponderBody, headers: HttpHeaders = HttpHeaders.Empty): Response =
      Response(ResponsePrelude(this, HttpHeaders.RawHeader("WWW-Authenticate", wwwAuthenticate) +: headers), body)
*/
  }
...
/*
    def apply(allowed: TraversableOnce[Method], body: ResponderBody, headers: HttpHeaders = HttpHeaders.Empty): Response =
      Response(ResponsePrelude(this, HttpHeaders.RawHeader("Allowed", allowed.mkString(", ")) +: headers), body)
*/
  }
...
/*
    // TODO type this header
    def apply(proxyAuthenticate: String, body: ResponderBody, headers: HttpHeaders = HttpHeaders.Empty): Response =
      Response(ResponsePrelude(this, HttpHeaders.RawHeader("Proxy-Authenticate", proxyAuthenticate) +: headers), body)
*/
  }
