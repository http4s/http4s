...
object MultipartParser {
  ...
  def parse(boundary: Boundary, headerLimit: Long = 40 * 1024): Pipe[Task, Byte, Either[Headers, Byte]] = ???

//  def parse(boundary: Boundary, headerLimit: Long = 40 * 1024): Writer1[Headers, ByteVector, ByteVector] = {
...
//      }
//
//      def headers(leading: Option[ByteVector]): Pipe[Task, ByteVector, Out[Headers]] = {
