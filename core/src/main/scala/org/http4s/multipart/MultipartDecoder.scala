...
//          DecodeResult {
//            msg.body
//              .through(MultipartParser.parseStreamed[F](Boundary(boundary)))
//              .compile
//              .last
//              .map[Either[DecodeFailure, Multipart[F]]](
//                _.fold(InvalidMessageBodyFailure("Cannot decode multipart of an empty stream")
//                  .asLeft[Multipart[F]])(_.asRight)
//              )
//              .handleError {
//                case e: InvalidMessageBodyFailure => Left(e)
//                case e => Left(InvalidMessageBodyFailure("Invalid multipart body", Some(e)))
