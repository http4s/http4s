...
private[util] trait UrlCodingUtils {
  ...
  def urlEncode(toEncode: String, charset: Charset = Utf8, spaceIsPlus: Boolean = false, toSkip: Char => Boolean = toSkip): String = {
  ...
  def urlDecode(toDecode: String, charset: Charset = Utf8, plusIsSpace: Boolean = false, toSkip: Char => Boolean = Function.const(false)): String = {
