...
object CharsetRange {
  ...
  implicit final val http4sEqForCharsetRange: Eq[CharsetRange] = Eq.fromUniversalEquals
  implicit final val http4sShowForCharsetRange: Show[CharsetRange] = Show.fromToString
}
