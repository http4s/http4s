...
trait MultipartParserBase {
  ...
  private[multipart] val logger = org.log4s.getLogger
  ...
  private[multipart] val PullUnit = Pull.pure[Pure, Unit](())
...
object MultipartParser extends MultipartParserBase with PlatformMultipartParser
