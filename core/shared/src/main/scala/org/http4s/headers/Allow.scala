...
/** A Response header that lists the methods that are supported by the target resource. Must be
  * attached to responses with status
  * [[https://tools.ietf.org/html/rfc7231#section-6.5.5 405 Not Allowed]], though in practice not
  * all servers honor this.
  *
