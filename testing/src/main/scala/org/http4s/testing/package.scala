...
package object testing {
  ...
  val `application/atom+xml`: MediaType =
    new MediaType("application", "atom+xml", true, false, List("atom"))
  ...
  val `application/vnd.ms-fontobject`: MediaType = new MediaType(
    "application",
    "vnd.ms-fontobject",
    MimeDB.Compressible,
    MimeDB.Binary,
    List("eot"))
  val `image/jpeg`: MediaType =
  ...
  val `audio/mpeg`: MediaType = new MediaType(
    "audio",
    "mpeg",
    MimeDB.Uncompressible,
    MimeDB.Binary,
    List("mpga", "mp2", "mp2a", "mp3", "m2a", "m3a"))
  val `multipart/form-data`: MediaType =
    new MediaType("multipart", "form-data", MimeDB.Uncompressible, MimeDB.NotBinary)
