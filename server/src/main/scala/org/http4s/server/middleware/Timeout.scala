...
object Timeout {
  ...
  /** Transform the service to return a timeout response after the given duration if the service has
    * not yet responded. If the timeout fires, the service's response is canceled.
    *
    * @param timeout
