...
class TwirlSpec extends Http4sSpec {
  ...
  "HTML encoder" should {
    ...
    "render the body" in prop { implicit cs: Charset =>
      ...
      text.decode(resp.unsafePerformSync, strict = false).run.unsafePerformSync must be_\/-("<h1>test html</h1>")
    }
  }
  ...
  "JS encoder" should {
    ...
    "render the body" in prop { implicit cs: Charset =>
      ...
      text.decode(resp.unsafePerformSync, strict = false).run.unsafePerformSync must be_\/-(""""test js"""")
    }
  }
  ...
  "Text encoder" should {
    ...
    "render the body" in prop { implicit cs: Charset =>
      ...
      text.decode(resp.unsafePerformSync, strict = false).run.unsafePerformSync must be_\/-("""test text""")
    }
  }
  ...
  "XML encoder" should {
    ...
    "render the body" in prop { implicit cs: Charset =>
      ...
      text.decode(resp.unsafePerformSync, strict = false).run.unsafePerformSync must be_\/-("<test>test xml</test>")
    }
  }
}
