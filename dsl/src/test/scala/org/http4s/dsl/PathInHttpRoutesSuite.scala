...
class PathInHttpRoutesSuite extends Http4sSuite {
  object List {
    def unapplySeq(params: Map[String, collection.Seq[String]]): Option[Seq[String]] =
      params.get("list")
    def unapply(params: Map[String, collection.Seq[String]]): Option[Seq[String]] = unapplySeq(
      params
    )
  }
