...
* <span class="badge bg-warning text-dark">Milestone</span> releases are
...
* <span class="badge bg-success">Stable</span> releases are
...
* <span class="badge bg-secondary">EOL</span> releases are no
...
<table class="table table-responsive table-hover">
  ...
  <tbody>
	<tr>
	  ...
	  <td class="text-center"><span class="badge bg-warning text-dark">Milestone</span></td>
	...
	<tr>
	  ...
	  <td class="text-center"><span class="badge bg-success">Stable</span></td>
	  <td class="text-center"><i class="fa fa-ban"></i></td>
	  <td class="text-center"><i class="fa fa-ban"></i></td>
	  <td class="text-center"><i class="fa fa-check"></i></td>
	  <td class="text-center"><i class="fa fa-check"></i></td>
    ...
    <tr>
	  ...
	  <td class="text-center"><span class="badge bg-secondary">EOL</span></td>
	  <td class="text-center"><i class="fa fa-ban"></i></td>
	  <td class="text-center"><i class="fa fa-ban"></i></td>
	  <td class="text-center"><i class="fa fa-check"></i></td>
	  <td class="text-center"><i class="fa fa-check"></i></td>
