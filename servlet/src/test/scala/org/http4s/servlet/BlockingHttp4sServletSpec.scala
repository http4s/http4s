...
class BlockingHttp4sServletSpec(implicit ee: ExecutionEnv) extends Http4sSpec {
  ...
  lazy val servlet = new BlockingHttp4sServlet[IO](
    service = service,
    servletIo = org.http4s.servlet.BlockingServletIo(4096, testBlockingExecutionContext),
