...
private[http4s] abstract class DefaultClient[F[_]](implicit F: BracketThrow[F]) extends Client[F] {
  ...
  /** Returns this client as an [[HttpService]]. It is the responsibility of callers of this service
    ...
    *
    * This is intended for use in proxy servers. `run`, `fetchAs`, [[toKleisli]], [[streaming]] are
    * safer alternatives, as their signatures guarantee disposal of the HTTP connection.
    */
